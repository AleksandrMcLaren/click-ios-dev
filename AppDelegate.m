...
- (void)applicationDidBecomeActive:(UIApplication *)application {
    ...
    if([CKMessageServerConnection sharedInstance].token && [CKMessageServerConnection sharedInstance].token.length)
    {
        if(![CKMessageServerConnection sharedInstance].isConnected)
             [[CKMessageServerConnection sharedInstance] connect];
    }
}
