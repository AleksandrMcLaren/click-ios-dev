...
#import "CKGroupHeaderView.h"
#import <objc/runtime.h>
#import <objc/message.h>

#define DEFAULT_PLACEHOLDER_COLOR (CKClickProfileGrayColor)
#define DRAW_DEBUG 0
...
@implementation CKGroupHeaderView

{
    UIView *_nameSeparatorView;
    UIView *_descriptionTextSeparatorView;
}
...
//        _descriptionText.placeholder = @"Описание группы";
        _descriptionText.tag = 1;
        _descriptionText.font = [UIFont systemFontOfSize:10.0];
        _descriptionText.backgroundColor = [UIColor whiteColor];
        _descriptionText.placeholder = @"При желании введите Краткое\nописание группы и установите\nкартинку";
        [_descriptionText setup];
        ...
        _descriptionTextSeparatorView = [UIView new];
        _descriptionTextSeparatorView.backgroundColor = CKClickProfileGrayColor;
        [self addSubview:_descriptionTextSeparatorView];
        ...
        [_nameSeparatorView makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.top.equalTo(_name.bottom).offset(11);
            make.right.equalTo(self.right).offset(-16);
            make.height.equalTo(0.5);
        }];
        [_descriptionText makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(_avatar.right).offset(16);
            make.top.equalTo(_nameSeparatorView).offset(3);
            make.right.equalTo(self.right);
            make.height.equalTo(40);
        }];

        [_descriptionTextSeparatorView makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(_descriptionText.left);
            make.top.equalTo(_descriptionText.bottom).offset(11);
            make.right.equalTo(self.right);
            make.height.equalTo(0.5);
        }];
