...
//	NSPredicate *predicate = [NSPredicate predicateWithFormat:@"objectId != %@ AND fullname CONTAINS[c] %@", [CKUser currentId], text];
//	dbusers = [[DBUser objectsWithPredicate:predicate] sortedResultsUsingProperty:CKUser_FULLNAME ascending:YES];
...

{
	...
	object[FGROUP_USERID] = [CKUser currentId];
...

{
	...
	[selection addObject:[CKUser currentId]];
...

{
	...
	CKUser *dbuser = dbusers_section[indexPath.row];
