...
+ (void)loadPictureMedia:(PhotoMediaItem *)mediaItem dbmessage:(Message *)dbmessage wifi:(BOOL)wifi
		  collectionView:(UICollectionView *)collectionView
...
+ (void)downloadPictureMedia:(PhotoMediaItem *)mediaItem dbmessage:(Message *)dbmessage
			  collectionView:(UICollectionView *)collectionView
...
//			[self showPictureFile:mediaItem Path:path collectionView:collectionView];
//			
//			if ([CKUser autoSaveMedia]) [self savePictureAlbum:mediaItem dbmessage:dbmessage path:path];
//		}
...
+ (void)loadPictureAlbum:(PhotoMediaItem *)mediaItem dbmessage:(Message *)dbmessage wifi:(BOOL)wifi
		  collectionView:(UICollectionView *)collectionView
...
+ (void)savePictureAlbum:(PhotoMediaItem *)mediaItem dbmessage:(Message *)dbmessage path:(NSString *)path
...
+ (void)loadVideoMedia:(VideoMediaItem *)mediaItem dbmessage:(Message *)dbmessage wifi:(BOOL)wifi
		collectionView:(UICollectionView *)collectionView
...
+ (void)downloadVideoMedia:(VideoMediaItem *)mediaItem dbmessage:(Message *)dbmessage
   collectionView:(UICollectionView *)collectionView
...
//			[self showVideoFile:mediaItem Path:path collectionView:collectionView];
//			
//			if ([CKUser autoSaveMedia]) [self saveVideoAlbum:mediaItem dbmessage:dbmessage path:path collectionView:collectionView];
//		}
//		else mediaItem.status = STATUS_MANUAL;
//		[collectionView reloadData];
//	}];
...
+ (void)loadVideoAlbum:(VideoMediaItem *)mediaItem dbmessage:(Message *)dbmessage wifi:(BOOL)wifi
		collectionView:(UICollectionView *)collectionView
...
+ (void)saveVideoAlbum:(VideoMediaItem *)mediaItem dbmessage:(Message *)dbmessage path:(NSString *)path1
		collectionView:(UICollectionView *)collectionView
...
+ (void)loadAudioMedia:(AudioMediaItem *)mediaItem dbmessage:(Message *)dbmessage wifi:(BOOL)wifi
		collectionView:(UICollectionView *)collectionView
...
+ (void)downloadAudioMedia:(AudioMediaItem *)mediaItem dbmessage:(Message *)dbmessage
   collectionView:(UICollectionView *)collectionView
...
//			[self showAudioFile:mediaItem Path:path collectionView:collectionView];
//			
//			if ([CKUser autoSaveMedia]) [self saveAudioAlbum:mediaItem dbmessage:dbmessage path:path collectionView:collectionView];
//		}
//		else mediaItem.status = STATUS_MANUAL;
//		[collectionView reloadData];
//	}];
...
+ (void)loadAudioAlbum:(AudioMediaItem *)mediaItem dbmessage:(Message *)dbmessage wifi:(BOOL)wifi
		collectionView:(UICollectionView *)collectionView
...
+ (void)saveAudioAlbum:(AudioMediaItem *)mediaItem dbmessage:(Message *)dbmessage path:(NSString *)path1
		collectionView:(UICollectionView *)collectionView
